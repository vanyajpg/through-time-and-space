            ...
            <div>
                ...
                <ReactCardFlip isFlipped={flip}
                    ...
                    <div className='text-center'>
                        ...
                        <br />
                        <br />
                        <button className='bg-[#737484] hover:bg-[#d9d9de] bg-opacity-30 hover:bg-opacity-10 px-12 py-2 rounded transition duration-300 mb-8' onClick={() => setFlip(!flip)}>
                            Flip</button>
                    </div>
                    <div className=''>
                        <div className=' w-full text-center'>
                            ...
                            <br />
                            <button className=' text-lg bg-[#737484] hover:bg-[#d9d9de] bg-opacity-30 hover:bg-opacity-10 px-12 py-2 rounded transition duration-300 mb-8 ' onClick={() => setFlip(!flip)}>
                                Flip
                            </button>
                        </div>
                    </div>
